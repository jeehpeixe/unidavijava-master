...
public class TaskDAO extends SQLiteOpenHelper {
    ...
    public Task retrieve(int id) {
        ...
        Cursor cursor = db.query(
                            TABLE_TASKS,
                            new String[]{ROW_ID, ROW_NAME, ROW_DESCRIPTION},
                           ROW_ID + "=?",
    ...
    public int update(Task task) {
        ...
        // updating row
        return db.update(TABLE_TASKS, values,ROW_ID + " = ?", new String[]{String.valueOf(task.getId())});
    }

    public void delete(Task task) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TABLE_TASKS, ROW_ID + " = ?", new String[]{String.valueOf(task.getId())});
        db.close();
    }
}